...
export(Array, int, "None", "Unarmed", "Sword", "Dagger", "Bludgeon", "Axe", "Polearm", "Gloves",
 "Bow", "Staff", "Tome", "Magic", "Shield", "Heavy Headwear", "Light Headwear",
 "Heavy Armor", "Medium Armor", "Light Armor", "Heavy Boots", "Light Boots") var type
export(Array, String, "Primary_Hand", "Secondary_Hand", "Tertiary_Hand", "Head", "Body", "Leg") var slot
